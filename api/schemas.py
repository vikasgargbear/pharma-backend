...
class ProductBase(BaseModel):
    ...
    product_type: Optional[str] = Field(None, example="syrup")
    hsn_code: Optional[str] = Field(None, example="33")
    gst_percent: Optional[float] = Field(None, example=10.0)
    cgst_percent: Optional[float] = Field(None, example=5.0)
    sgst_percent: Optional[float] = Field(None, example=5.0)
    ...
    # Drug schedule fields
    drug_schedule: Optional[str] = Field(None, example="H", description="Indian pharma drug schedule (G, H, H1, X)")
    requires_prescription: Optional[bool] = Field(False, example=True)
    controlled_substance: Optional[bool] = Field(False, example=False)
    
    # Additional pharmaceutical product details
    generic_name: Optional[str] = Field(None, example="Paracetamol")
    composition: Optional[str] = Field(None, example="Each tablet contains: Paracetamol IP 500mg")
    dosage_instructions: Optional[str] = Field(None, example="As directed by the physician")
    ...
    pack_quantity: Optional[int] = Field(None, example=15)
    pack_form: Optional[str] = Field(None, example="Tablets")
    is_discontinued: Optional[bool] = Field(False, example=False)
    color: Optional[str] = Field(None, example="White")
    asin: Optional[str] = Field(None, example="B08BXFZKTG")
